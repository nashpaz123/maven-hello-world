...
Load azure-pipelines.yml to Azure Devops to package artifact, add artifact to image at Dockerhun and run it.

I've left some commented sections for future play with built in Azure Devops modules.
